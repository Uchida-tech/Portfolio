...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<yard>.freeze, ["~> 0.9.11".freeze])
  s.add_runtime_dependency(%q<pry>.freeze, ["~> 0.11".freeze])
  s.add_development_dependency(%q<latest_ruby>.freeze, ["~> 3.3".freeze])
